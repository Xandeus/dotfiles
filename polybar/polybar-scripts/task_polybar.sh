...
most_urgent_proj=`task rc.verbose: rc.report.next.columns:project rc.report.next.labels:1 limit:1 next`
...
echo "$most_urgent_proj: $most_urgent_desc ·  $most_urgent_due"
